                                ...
                                <div class="boxWrap" v-if="gussTab_home">
                                    ...
                                    <div class="boxInner">
                                        <div class="bet">
                                            ...
                                            <div class="item"
                                                 :class="{'endItem':fmdetail.odds[140].State=='1'&&fmdetail.odds[140].Selections['50'].State==='0', 'slt':current===fmdetail.odds[140].Selections['50'],'item-end':fmdetail.odds[140].State==='3'&&fmdetail.odds[140].result!=='50','item-zj': fmdetail.odds[140].Selections['50'].golds&&fmdetail.odds[140].Selections['50'].prize_state==='1'&&fmdetail.odds[140].Selections['50'].bonus!=='0' }"
                                                 v-tap="{methods: selectItem, params: {item: fmdetail.odds[140].Selections['50'], ruleType: '140', rule: fmdetail.odds[140]}}"
                                            >
                                                <span class="item-xx">胜其它</span>
                                                <span class="item-pl"
                                                      :class="{'changeColor':stat['1402'],'item-gray':fmdetail.odds[140].State==='3'&&fmdetail.odds[140].result==='50'}">{{ fmdetail.odds[140].Selections[50].BackOdds
                                                    }}</span>
                                                <span class="item-zc">{{ fmdetail.odds[140].Selections['50'].support
                                                    }}支持</span>
                                                <div class="endTips"
                                                     v-if="fmdetail.odds[140].State=='1'&&fmdetail.odds[140].Selections['50'].State==='0'">
                                                    封盘中...
                                        ...
                                        <div class="betShow"
                                             :class="{'hide':!fmdetail.odds[140].Selections['30005'].golds &&
                                                     ...
                                                     !fmdetail.odds[140].Selections['50'].golds
                                            }"
                                        >
                                            <div class="item">
                                                <template
                                            ...
                                            <div class="item">
                                                <template
                                                        v-if="fmdetail.odds[140].Selections['50'].golds&&fmdetail.odds[140].Selections['50'].prize_state==='-1'">
                                                    <i class="icon-jinbi"></i><em
                                                        class="emColor">{{fmdetail.odds[140].Selections['50'].golds |
                                                format}}</em>
                                                    <p>可中{{fmdetail.odds[140].Selections['50'].bonus | format}}</p>
                                                </template>
                                                <template
                                                        v-if="fmdetail.odds[140].Selections['50'].golds&&fmdetail.odds[140].Selections['50'].prize_state==='1'">
                                                    <i class="icon-jinbi"></i><em
                                                        class="gray">{{fmdetail.odds[140].Selections['50'].golds |
                                                format}}</em>
                                                    <p v-if="fmdetail.odds[140].Selections['50'].bonus!=='0'"
                                                       class="red">
                                                        中{{fmdetail.odds[140].Selections['50'].bonus | format}}</p>
                                                </template>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="boxWrap" v-if="gussTab_away">
                                    ...
                                    <div class="boxInner">
                                        <div class="bet">
                                            ...
                                            <div class="item"
                                                 :class="{'endItem':fmdetail.odds[140].State=='1'&&fmdetail.odds[140].Selections['51'].State==='0', 'slt':current===fmdetail.odds[140].Selections['51'],'item-end':fmdetail.odds[140].State==='3'&&fmdetail.odds[140].result!=='51','item-zj': fmdetail.odds[140].Selections['51'].golds&&fmdetail.odds[140].Selections['51'].prize_state==='1'&&fmdetail.odds[140].Selections['51'].bonus!=='0' }"
                                                 v-tap="{methods: selectItem, params: {item: fmdetail.odds[140].Selections['51'], ruleType: '140', rule: fmdetail.odds[140]}}"
                                            >
                                                <span class="item-xx">负其它</span>
                                                <span class="item-pl"
                                                      :class="{'changeColor':stat['1404'],'item-gray':fmdetail.odds[140].State==='3'&&fmdetail.odds[140].result==='51'}">{{ fmdetail.odds[140].Selections[51].BackOdds
                                                    }}</span>
                                                <span class="item-zc">{{ fmdetail.odds[140].Selections['51'].support
                                                    }}支持</span>
                                                <div class="endTips"
                                                     v-if="fmdetail.odds[140].State=='1'&&fmdetail.odds[140].Selections['51'].State==='0'">
                                                    封盘中...
                                        ...
                                        <div class="betShow"
                                             :class="{'hide':!fmdetail.odds[140].Selections['50003'].golds &&
                                                     ...
                                                     !fmdetail.odds[140].Selections['51'].golds
                                            }"
                                        >
                                            ...
                                            <div class="item">
                                                <template
                                                        v-if="fmdetail.odds[140].Selections['51'].golds&&fmdetail.odds[140].Selections['51'].prize_state==='-1'">
                                                    <i class="icon-jinbi"></i><em
                                                        class="emColor">{{fmdetail.odds[140].Selections['51'].golds |
                                                format}}</em>
                                                    <p>可中{{fmdetail.odds[140].Selections['51'].bonus | format}}</p>
                                                </template>
                                                <template
                                                        v-if="fmdetail.odds[140].Selections['51'].golds&&fmdetail.odds[140].Selections['51'].prize_state==='1'">
                                                    <i class="icon-jinbi"></i><em
                                                        class="gray">{{fmdetail.odds[140].Selections['51'].golds |
                                                format}}</em>
                                                    <p v-if="fmdetail.odds[140].Selections['51'].bonus!=='0'"
                                                       class="red">
                                                        中{{fmdetail.odds[140].Selections['51'].bonus | format}}</p>
                                                </template>
                                            </div>
                                        </div>
                                    </div>
        ...
        methods: {
            ...
            goMyPages ({target}) {
                ...
                case 'betlist':
                    ...
                    _hmt.push(['_trackEvent', '500qqsd_投注页猜球记录点击', 'click', '500qqsd_投注页猜球记录'])
                    break
                case 'homeHot':
                    _hmt.push(['_trackEvent', '500qqsd_投注页home点击', 'click', '500qqsd_投注页home'])
                    $('body').scrollTop(0)
...
//                        this.$router.push(`/h5/home/hot`)
                ...
                case 'eventCount':
                    ...
                    _hmt.push(['_trackEvent', '500qqsd_投注页事件统计点击', 'click', '500qqsd_投注页事件统计'])
                    break
                }
            },
            changeTab ({tab}) {
                ...
                _hmt.push(['_trackEvent', '500qqsd_投注页选项点击', 'click', '500qqsd_投注页选项拼音' + tab])
            },
            format2 (num) {
//                金币格式处理
                num = Number(num)
