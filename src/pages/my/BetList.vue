<template>
    <div class="respon2-itm bg2"  v-if="goldList">
        <div style="height: 100%">
            <section class="full-scroll">
                <div class="list" v-if="goldList.currentmatch.matchinfo&&goldList.currentmatch.matchinfo.MatchID">
                    <div class="list-tit">
                        <h3>本场记录</h3>
                    </div>
                    <div class="list-cont">
                        <div class="cont-tit">
                            <div class="fl"> {{goldList.currentmatch.matchinfo.HomeTeamName}}
                            ...
                            <div class="fr">
                                <span class="btn-goBet" data-type="开始竞猜" data-tab="beginBet" v-tap="{methods: beginBet}" v-if="(!goldList.currentmatch.list&&goldList.currentmatch.matchinfo.State!='1')||(!goldList.currentmatch.list.length&&goldList.currentmatch.matchinfo.State!='1')">开始竞猜<i class="icon-raw"></i></span>
                                <span class="btn-goBet" key="wcy" v-tap="{methods: beginBet}" v-if="goldList.currentmatch.matchinfo.State==='1'&&!goldList.currentmatch.list.length">未参与<i class="icon-raw"></i></span>
                                <div v-tap="{methods: switchMatch, matchinfo: goldList.currentmatch.matchinfo}" v-if="goldList.currentmatch.list&&goldList.currentmatch.list.length">
                    ...
                    <div class="list-cont" v-for="item in day.list" v-tap="{methods: switchMatch, matchinfo: item.matchinfo}">
                        <div class="cont-tit">
                            ...
                            <div class="fr">
                                ...
                                <i class="icon-raw icon-rawup" :class="{'rotate180': shows[item.matchinfo.MatchID]}"></i>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            showFirst () {
                if (this.goldList) {
                    ...
                    } else if (this.goldList.orders && this.goldList.orders[0] && this.goldList.orders[0].list && this.goldList.orders[0].list[0] && this.goldList.orders[0].list[0].matchinfo && this.goldList.orders[0].list[0].matchinfo.MatchID) {
        ...
        computed: {
            goldList () {
                return this.$store.state.my.goldList
            },
            currentMatchID_my () {
        ...
        mounted () {
            if (this.$route.params.others && this.$route.params.others === 'fromMain') {
                this.$store.dispatch(aTypes.getGoldList, this.currentMatchID_my)
            } else {
                this.$store.dispatch(aTypes.getGoldList, 0)
            }
        }
    }
